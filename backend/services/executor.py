...
from services.server_service import WorkspaceContext, detect_capabilities, load_workspace_context
    ...
    *,
    ...
    async def _refresh_context() -> WorkspaceContext:
        ...
        try:
            ...
            logger.info("[executor] context_refresh_success | new_version=%s", refreshed.version)
            return refreshed
